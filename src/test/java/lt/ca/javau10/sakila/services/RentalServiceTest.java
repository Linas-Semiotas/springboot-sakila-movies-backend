...
public class RentalServiceTest {
    ...
    public void setUp() {
        ...
        rentalDto1 = new RentalDto(movie1.getFilmId(), movie1.getTitle(), movie1.getRentalRate(), movie1.getReplacementCost(), movie1.getRentalDuration());
        rentalDto2 = new RentalDto(movie2.getFilmId(), movie2.getTitle(), movie2.getRentalRate(), movie2.getReplacementCost(), movie2.getRentalDuration());
    }
